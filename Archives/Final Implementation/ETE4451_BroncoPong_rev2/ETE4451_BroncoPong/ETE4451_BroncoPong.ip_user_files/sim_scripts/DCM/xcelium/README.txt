...
#
# Generated by export_simulation on Mon May 10 17:35:01 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './DCM.sh' script.
...
./DCM.sh -noclean_files

For more information on the script, please type './DCM.sh -help'.
