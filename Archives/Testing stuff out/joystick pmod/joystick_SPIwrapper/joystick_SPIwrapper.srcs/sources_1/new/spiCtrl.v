...
module spiCtrl(
	...
	// ===========================================================================
			...
			output [39:0] DOUT;			// All data read from the slave
			         // 20 bits for x position of joystick
			         // 20 bits for y position of joystick
			...
			if(RST == 1'b1) begin
					...
					case(pState)
								...
								Init : begin
										...
										if(BUSY == 1'b1) begin                // If busy = 1'b1 then data transfer is in progress
												pState <= Wait;
								...
								Check : begin
										...
										if(byteCnt == 3'd5) begin         // Looking to see five bytes in the packet
												pState <= Done;
										end
