...
module ssdCtrl(
	...
	// ===========================================================================
			...
			reg [3:0] AN = 4'hF;
			reg [6:0] local_SEG = 7'b0;
			
			not G1(SEG[0],local_SEG[0]); // invert outputs for active low LEDs
			not G2(SEG[1],local_SEG[1]);
			not G3(SEG[2],local_SEG[2]);
			not G4(SEG[3],local_SEG[3]);
			not G5(SEG[4],local_SEG[4]);
			not G6(SEG[5],local_SEG[5]);
			not G7(SEG[6],local_SEG[6]);
	...
	// ===========================================================================
			...
			always @(posedge DCLK) begin
					if(RST == 1'b1) begin
							local_SEG <= 7'b1000000;
					end
					else begin
							case (muxData)

									4'h0 : local_SEG <= 7'b1000000;  // 0
									4'h1 : local_SEG <= 7'b1111001;  // 1
									4'h2 : local_SEG <= 7'b0100100;  // 2
									4'h3 : local_SEG <= 7'b0110000;  // 3
									4'h4 : local_SEG <= 7'b0011001;  // 4
									4'h5 : local_SEG <= 7'b0010010;  // 5
									4'h6 : local_SEG <= 7'b0000010;  // 6
									4'h7 : local_SEG <= 7'b1111000;  // 7
									4'h8 : local_SEG <= 7'b0000000;  // 8
									4'h9 : local_SEG <= 7'b0010000;  // 9
									default : local_SEG <= 7'b1000000;
