...
HD_PWD='C:/Users/George/Desktop/Github/Bronco Pong/Testing stuff out/HDMI_rev0/HDMI_rev0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log videoGenerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source videoGenerator.tcl -notrace
