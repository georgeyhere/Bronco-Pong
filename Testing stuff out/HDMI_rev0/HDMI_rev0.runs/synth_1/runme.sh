...
HD_PWD='C:/Users/George/Desktop/Github/Bronco Pong/Testing stuff out/HDMI_rev0/HDMI_rev0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log videoGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source videoGenerator.tcl
