...
##Clock signal
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { PClk }]; IO_L12P_T1_MRCC_35 Sch=PClk
create_clock -add -name sys_clk_pin -period 40.00 -waveform {0 20} [get_ports { PClk }];
