...
#
# Generated by export_simulation on Wed Apr 14 15:42:55 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './VideoBuffer.sh' script.

./VideoBuffer.sh -reset_run
...
./VideoBuffer.sh -noclean_files

For more information on the script, please type './VideoBuffer.sh -help'.
