...
proc create_root_design { parentCell } {
  ...
  set Clk_250MHz_0 [ create_bd_port -dir O -type clk Clk_250MHz_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {250000000} \
 ] $Clk_250MHz_0
  set Clk_25MHz_0 [ create_bd_port -dir O -type clk Clk_25MHz_0 ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT3_PORT {Clk_100MHz} \
  ...
  connect_bd_net -net clk_wiz_0_Clk_250MHz [get_bd_ports Clk_250MHz_0] [get_bd_pins clk_wiz_0/Clk_250MHz]
  connect_bd_net -net clk_wiz_0_Clk_25MHz [get_bd_ports Clk_25MHz_0] [get_bd_pins clk_wiz_0/Clk_25MHz]
